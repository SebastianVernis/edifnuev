...
const pageDescriptions = {
  login: {
    ...
    elements: [
      {
        type: "header",
        content: "ChispartBuilding - Sistema de Gestión para Condominios",
      },
      {
        type: "input",
        id: "email",
        label: "Email",
        placeholder: "usuario@edificio205.com",
      },
    ...
    steps: [
      {
        ...
        description:
          "User opens the login page and sees the authentication form",
        uiElements: [
          "Email input field",
      ...
      },
      {
        ...
        description:
          "User enters email: admin@edificio205.com and password: Gemelo1",
      ...
      },
      {
        ...
        description:
          "Admin dashboard displays with full navigation menu and statistics cards",
        uiElements: [
      ...
      },
      {
        ...
        description:
          "Usuarios management panel opens showing list of all users",
  ...
  inquilino: {
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          "User enters email: maria.garcia@edificio205.com and password: Gemelo1",
        uiElements: ["Filled email field", "Filled password field (masked)"],
      },
      {
        step: 3,
        ...
        expectedResponse: {
          ok: true,
          token: "[JWT_TOKEN]",
          usuario: { rol: "INQUILINO", departamento: "101" },
        },
      },
      {
        step: 4,
        ...
        description:
          "Inquilino dashboard displays with limited navigation menu",
        uiElements: [
      ...
      },
      {
        ...
        description:
          "Personal requests panel shows only this tenant's requests",
...
function generateVisualDocumentation() {
  ...
  markdown += `- **Secondary Button** (\`.btn-primary\`) - Secondary actions\n`;
...
console.log(
  `📊 Total pages documented: ${Object.keys(pageDescriptions).length}`,
);
console.log(`🔄 Total test flows: ${Object.keys(testFlows).length}`);
console.log(
  `📸 Total simulated screenshots: ${testFlows.admin.steps.length + testFlows.inquilino.steps.length}`,
);

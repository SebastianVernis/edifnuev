  ...
  const permisosConfig = [
    {
      ...
      description: "Puede crear, editar y eliminar anuncios",
      color: "primary",
    },
    {
      key: "gastos",
      ...
      description: "Puede registrar y administrar gastos",
      color: "success",
    },
    {
      key: "presupuestos",
      ...
      description: "Puede crear y administrar presupuestos",
      color: "warning",
    },
    {
      key: "cuotas",
      ...
      description: "Puede gestionar cuotas y pagos",
      color: "info",
    },
    {
      key: "usuarios",
      ...
      description: "Puede administrar usuarios del sistema",
      color: "danger",
    },
    {
      key: "cierres",
      ...
      description: "Puede realizar cierres contables",
      color: "secondary",
    },
  ];
...
class UsuariosManager {
  constructor() {
    this.usuarios = [];
    this.usuarioModal = new bootstrap.Modal(
  ...
  setupEventListeners() {
    ...
    const btnLimpiarFiltrosUsuarios = document.getElementById(
      "btnLimpiarFiltrosUsuarios",
    );
    ...
    const filtroUsuarioBusqueda = document.getElementById(
  ...
  setupPermissionButtons() {
    ...
    if (btnSeleccionarTodos) {
      btnSeleccionarTodos.addEventListener("click", () => {
        document
          .querySelectorAll('#permisosSection input[type="checkbox"]')
          .forEach((checkbox) => {
  ...
  cargarDepartamentosEnFiltro() {
    const departamentosSelect = document.getElementById(
  ...
  verificarFiltrosActivos() {
    ...
    return (
      rol !== "" || estado !== "" || departamento !== "" || busqueda !== ""
    );
  }
  ...
  showUsuarioModal(usuario = null) {
    ...
    if (usuario) {
      ...
      document.getElementById("usuarioDepartamento").value =
      ...
      if (usuario.rol === "COMITE" && usuario.permisos) {
        ...
        if (usuario.permisos.anuncios)
          document.getElementById("permisoAnuncios").checked = true;
        if (usuario.permisos.gastos)
          document.getElementById("permisoGastos").checked = true;
        if (usuario.permisos.presupuestos)
          document.getElementById("permisoPresupuestos").checked = true;
        if (usuario.permisos.cuotas)
          document.getElementById("permisoCuotas").checked = true;
        if (usuario.permisos.usuarios)
          document.getElementById("permisoUsuarios").checked = true;
        if (usuario.permisos.cierres)
          document.getElementById("permisoCierres").checked = true;
      }
    } else {
      document.getElementById("usuarioModalLabel").textContent =
        "Nuevo Usuario";
    ...
    try {
      ...
      if (rol === "COMITE") {
        ...
        if (!tienePermisos) {
          showAlert(
            "alertContainer",
            "Debe seleccionar al menos un permiso para usuarios del comité",
            "warning",
          );
          return;
        }
                ...
                <div class="modal fade" id="confirmActionModal" tabindex="-1" aria-labelledby="confirmActionModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" id="btnCancelAction">Cancelar</button>
